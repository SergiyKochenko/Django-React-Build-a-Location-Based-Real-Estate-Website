...
// Displaying the boroughs on the map
    ...
    useEffect(() => {
        console.log('Latitude: ', state.latitudeValue, 'Longitude: ', state.longitudeValue)
    }, [state.latitudeValue, state.longitudeValue, state.mapInstance, dispatch])
...
{/* Map */}
                ...
                <Button onClick={()=>state.mapInstance.flyTo([51.5318314686333, -0.07821153682234076], 15)}>TEST BUTTON</Button>
