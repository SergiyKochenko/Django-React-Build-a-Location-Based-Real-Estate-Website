...
- **Register page server-side password validation:** If the server returns password validation errors (e.g., password too similar, too common, or entirely numeric), the respective error message is displayed.
...
- **Listing Delete page feedback:** A message now informs users of successful property deletion.
- **User Logout page feedback:** A message now informs users of successful user logout.
